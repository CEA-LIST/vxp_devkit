...
static inline void _BCSR_dvusmv_6x1(args_t args)
{/* !!!! c * (6*1) */
    ...
    for (int brow = 0; brow < nbr; brow++) {
        ...
        y_ptr += 6*args.y_bytes;
    }
}

static inline void _BCSR_dvusmv_trans_6x1(args_t args)
{/* !!!! c * (6*1) */
    int c = args.a->col_block_size;
...
void BCSR_dvusmv_6x1(args_t args)
{
    if (args.trans == 'N')
        _BCSR_dvusmv_6x1(args);
    else
        _BCSR_dvusmv_trans_6x1(args);
}
