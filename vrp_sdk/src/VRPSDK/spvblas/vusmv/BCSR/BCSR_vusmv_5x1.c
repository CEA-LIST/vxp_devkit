...
static inline void _BCSR_dvusmv_5x1(args_t args)
{/* !!!! c * (5*1) */
    ...
    for (int brow = 0; brow < nbr; brow++) {
        ...
        y_ptr += 5*args.y_bytes;
    }
}

static inline void _BCSR_dvusmv_trans_5x1(args_t args)
{/* !!!! c * (5*1) */
    int c = args.a->col_block_size;
...
void BCSR_dvusmv_5x1(args_t args)
{
    if (args.trans == 'N')
        _BCSR_dvusmv_5x1(args);
    else
        _BCSR_dvusmv_trans_5x1(args);
}
