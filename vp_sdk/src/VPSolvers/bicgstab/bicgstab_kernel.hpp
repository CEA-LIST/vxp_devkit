...
#ifndef __BICGSTAB_KERNEL_HPP__
#define __BICGSTAB_KERNEL_HPP__
...
int bicgstab_vp(          // Solves Ax = b where A is a non-symetric square matrix using the BIConjugate Gradient STABilized method 
